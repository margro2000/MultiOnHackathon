...
export default function PrivacyPolicy() {
  return (
    <>
      ...
      <main>
        <section>
          <div className="container content my-32">
            ...
            <h4>Definitions</h4>
            <br />
            <p>For the purposes of these Privacy Policy:</p>
            <br />
            <ul>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our"`} in this Agreement) refers to ProjectionLab
                  LLC, 1 Washington Mall #1296 Boston Massachusetts 02108.
                </p>
                <br />
              </li>
              <li>
              ...
              <li>
                <p>
                  <strong>Lifetime Subscription</strong> refers to the lifetime
                  of the Service.
                </p>
                <br />
              </li>
              <li>
                <p>
                  <strong>Privacy Policy</strong> (also referred as {`"Terms"`})
                  mean these Privacy Policy that form the entire agreement
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to ProjectionLab, accessible
                  from{" "}
                  <a
                    href="https://projectionlab.com"
            ...
            <br />
            <p>
              These are the Privacy Policy governing the use of this Service and
              the agreement that operates between You and the Company. These
              Privacy Policy set out the rights and obligations of all users
              regarding the use of the Service.
            </p>
            <br />
            <p>
              Your access to and use of the Service is conditioned on Your
              acceptance of and compliance with these Privacy Policy. These
              Privacy Policy apply to all visitors, users and others who access
              or use the Service.
            </p>
            <br />
            <p>
              By accessing or using the Service You agree to be bound by these
              Privacy Policy. If You disagree with any part of these Terms and
            ...
            <p>
              ...
              (i) modify the Privacy Policy of the Free Trial offer, or (ii)
            ...
            <br />
            <p>
              We strongly advise You to read the Privacy Policy and privacy
            ...
            <p>
              ...
              without limitation if You breach these Privacy Policy.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              through the Service or 100 USD if  purchased anything
              through the Service.
            </p>
            <br />
            <p>
            ...
            <p>
              ...
              these states, each  liability will be limited to the
            ...
            <p>
              ...
              companys provider makes any representation or warranty of any
            ...
            <p>
              ...
              effect a partys ability to exercise such right or require such
            ...
            <br />
            <p>
              These Privacy Policy may have been translated if We have made them
              available to You on our Service. You agree that the original
              English text shall prevail in the case of a dispute.
            </p>
            <br />
            <h3>Changes to These Privacy Policy</h3>
            <br />
            <p>
            ...
            <br />
            <ul>
              <li>By email: support@support.com</li>
            </ul>
          </div>
        </section>
      </main>
